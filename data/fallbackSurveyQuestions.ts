...
import { SurveyQuestion } from '@/contexts/SurveyContext';

export const surveyQuestions: SurveyQuestion[] = [
  {
    id: "financial_goals",
    question: "What are your primary financial goals?",
    simplified_question: "What do you want to do with your money?",
  ...
  },
  {
    ...
    simplified_question: "How much money do you get each month?",
    type: "single-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "How much do you know about money?",
    type: "single-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "How do you use banks now?",
    type: "single-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "How do you save your money now?",
    type: "multiple-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "Do you need to borrow money now or soon?",
    type: "single-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "How good are you with money apps on your phone?",
    type: "single-choice",
    options: [
  ...
  },
  {
    ...
    simplified_question: "Do you want to see where your money goes?",
    type: "slider",
    min: 1,
    max: 5,
    labels: {
